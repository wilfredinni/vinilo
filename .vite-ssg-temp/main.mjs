...
import { useSSRContext, resolveComponent, mergeProps, withCtx, createTextVNode, defineComponent } from "vue";
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div class="mt-5 mx-auto text-center opacity-75 dark:opacity-50 text-sm"> [Default Layout] </div></main>`);
}
...
var __layout_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$2]]);
const layouts = {
  "default": __layout_0
};
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<!--[--><div class="mt-8 flex justify-center"><h1 class="text-3xl font-semibold text-gray-700">Page title</h1></div><div class="mt-12 flex justify-center text-lg font-semibold tracking-wider text-gray-700"> Page description </div>`);
  _push(ssrRenderComponent(_component_router_link, {
    to: "/about",
    class: "mx-auto mt-12 flex w-fit justify-center tracking-wider text-gray-700 underline"
  }, {
...
var __pages_import_1__ = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$1]]);
const __pages_import_0__ = () => Promise.resolve().then(function() {
  return about$1;
});
const routes$1 = [{ "name": "about", "path": "/about", "component": __pages_import_0__, "props": true }, { "name": "index", "path": "/", "component": __pages_import_1__, "props": true }];
...
const createApp = ViteSSG(_sfc_main$1, { routes, base: "/" }, (ctx) => {
  Object.values({ "./modules/pwa.ts": __glob_5_0 }).forEach((i) => {
    var _a;
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<h1${ssrRenderAttrs(mergeProps({ class: "text-2xl" }, _attrs))}>About</h1>`);
}
